...
void Nivel1::primer_piso()
{
    ...
    million_ants = new Nota(55,60,":/Mortys_Vindicator_Challenge/Sprites/hoja.png","Parece como si estuviera hecho de tierra");
...
void Nivel1::segundo_piso()
{
    ...
    supernova = new Nota(55, 60, ":/Mortys_Vindicator_Challenge/Sprites/hoja.png", "Es un elemento cosmico");
...
void Nivel1::tercer_piso()
{
    ...
    crocubot = new Nota(55, 60, ":/Mortys_Vindicator_Challenge/Sprites/hoja.png", "Es un elemento cosmico");
...
void Nivel1::cuarto_piso()
{
    ...
    alan_rails = new Nota(55, 60, ":/Mortys_Vindicator_Challenge/Sprites/hoja.png", "Su poder se basa en usar trenes ._.");
