...
{
    plataforma = new Plataforma(700,40,":/Mortys_Vindicator_Challenge/Sprites/plataforma_tipo1.png", this);
    plataforma -> setPos(900,670);
    nivel1 -> addItem(plataforma);
    lago_toxico = new Lago(48,411,":/Mortys_Vindicator_Challenge/Sprites/Lago toxico.png", this);
    lago_toxico -> setPos(1044,658);
    lago_toxico -> setZValue(1);
    nivel1 -> addItem(lago_toxico);
    plataforma_flotante = new Plataforma(210,35,":/Mortys_Vindicator_Challenge/Sprites/plataforma_2.png", this);
    plataforma_flotante -> setPos(1144,660);
    nivel1 -> addItem(plataforma_flotante);
    million_ants = new Nota(1, 1500,610, 55,60,":/Mortys_Vindicator_Challenge/Sprites/hoja.png","Parece como si estuviera hecho de tierra", this);
...
{
    plataforma2 = new Plataforma(700, 40, ":/Mortys_Vindicator_Challenge/Sprites/Plataforma_default.png", this);
    plataforma2 -> setPos(0, 580);
    nivel1 -> addItem(plataforma2);
    pincho = new Pincho(41, 41, ":/Mortys_Vindicator_Challenge/Sprites/spikes.png", this);
    pincho -> setPos(392,540);
    nivel1 -> addItem(pincho);
    supernova = new Nota(2, 32, 520, 55, 60, ":/Mortys_Vindicator_Challenge/Sprites/hoja.png", "Es un elemento cosmico", this);
...
{
    plataforma3 = new Plataforma(1300,40, ":/Mortys_Vindicator_Challenge/Sprites/Plataforma_default.png", this);
    plataforma3 -> setPos(300,410);
    nivel1 -> addItem(plataforma3);
    crocubot = new Nota(3, 1500, 350, 55, 60, ":/Mortys_Vindicator_Challenge/Sprites/hoja.png", "Es un reptil, pero con partes roboticas", this);
...
{
    plataforma4 = new Plataforma(1302, 40, ":/Mortys_Vindicator_Challenge/Sprites/plataforma_tipo1.png", this);
    plataforma4 -> setPos(0,172);
    plataforma4 -> setZValue(2);
    nivel1 -> addItem(plataforma4);
    plataforma_flotante2 = new Plataforma(350, 30, ":/Mortys_Vindicator_Challenge/Sprites/plataforma_2.png", this);
    plataforma_flotante2 -> setZValue(0);
    plataforma_flotante2 -> setPos(472, 164);
    nivel1 -> addItem(plataforma_flotante2);
    lago_toxico2 = new Lago(48, 411, ":/Mortys_Vindicator_Challenge/Sprites/Lago toxico.png", this);
    lago_toxico2 -> setPos(224,160);
    plataforma4 -> setZValue(1);
    nivel1 -> addItem(lago_toxico2);
    lago_toxico3 = new Lago(48, 411, ":/Mortys_Vindicator_Challenge/Sprites/Lago toxico.png", this);
    lago_toxico3 -> setPos(632,160);
    plataforma4 -> setZValue(1);
    nivel1 -> addItem(lago_toxico3);
    pincho4 = new Pincho(41, 41, ":/Mortys_Vindicator_Challenge/Sprites/spikes.png", this);
    pincho4 -> setPos(604, 124);
    nivel1 -> addItem(pincho4);
    pincho5 = new Pincho(41, 41, ":/Mortys_Vindicator_Challenge/Sprites/spikes.png", this);
    pincho5 -> setPos(645, 124);
    nivel1 -> addItem(pincho5);
    alan_rails = new Nota(5, 28, 115, 55, 60, ":/Mortys_Vindicator_Challenge/Sprites/hoja.png", "Su poder se basa en usar trenes ._.", this);
...
{
    plataforma3_5 = new Plataforma(40, 160, ":/Mortys_Vindicator_Challenge/Sprites/Plataforma_rotada_90.png", this);
    plataforma3_5 -> setPos(1264,172);
    nivel1 -> addItem(plataforma3_5);
    min_plat1 = new Plataforma(122, 30, ":/Mortys_Vindicator_Challenge/Sprites/plataforma_2.png", this);
    min_plat1 -> setPos(1300, 304);
    nivel1 -> addItem(min_plat1);
    min_plat2 = new Plataforma(122, 30, ":/Mortys_Vindicator_Challenge/Sprites/plataforma_2.png", this);
...
{
    base = new Plataforma(1600, 50, ":/Mortys_Vindicator_Challenge/Sprites/Plataforma_default.png", this);
    base ->  setPos(0,870);
    nivel1 -> addItem(base);
    min_plat_aux1 = new Plataforma(122,30, ":/Mortys_Vindicator_Challenge/Sprites/plataforma_2.png", this);
    min_plat_aux1 -> setPos(716, 752);
    nivel1 -> addItem(min_plat_aux1);
    min_plat_aux2 = new Plataforma(122,30, ":/Mortys_Vindicator_Challenge/Sprites/plataforma_2.png", this);
...
void Nivel1::spawn_morty()
{
    ...
    morty = new Morty(vindicadores, 90, 90, ":/Mortys_Vindicator_Challenge/Sprites/morty_default_right.png", this);
    morty -> setPos(1,600);
    morty -> setZValue(1);
    connect(morty, SIGNAL(morty_muerto()), this, SLOT(reiniciar()));
    nivel1 -> addItem(morty);
}

void Nivel1::poner_imagenes()
{
    millionAnts = new imagen(1, 70, 70, ":/Mortys_Vindicator_Challenge/Sprites/million ants.png", this);
    millionAnts -> setPos(908, 796);
    nivel1 -> addItem(millionAnts);
    super_nova = new imagen(2, 70,70, ":/Mortys_Vindicator_Challenge/Sprites/supernova.png", this);
    super_nova -> setPos(988, 796);
    nivel1 -> addItem(super_nova);
    robodrilo = new imagen(3, 70,70, ":/Mortys_Vindicator_Challenge/Sprites/crocubot.png", this);
    robodrilo -> setPos(1068, 796);
    nivel1 -> addItem(robodrilo);
    vance = new imagen(4, 70, 70, ":/Mortys_Vindicator_Challenge/Sprites/vance maximus.png", this);
    vance -> setPos(1148, 796);
    nivel1 -> addItem(vance);
    alanrails = new imagen(5, 70, 70, ":/Mortys_Vindicator_Challenge/Sprites/alan rieles.png", this);
    alanrails -> setPos(1228, 796);
    nivel1 -> addItem(alanrails);
    vance_maximus = new Nota(4, 908, 610, 55,60,":/Mortys_Vindicator_Challenge/Sprites/hoja.png","El tipo literalmente se cree Starlord", this);
...
{
    sierra1_1 = new Sierra(1, 50,50, ":/Mortys_Vindicator_Challenge/Sprites/sierra.png", this);
    sierra1_1 -> setPos(512, 320);
    nivel1 -> addItem(sierra1_1);
    sierra1_2 = new Sierra(1, 50,50, ":/Mortys_Vindicator_Challenge/Sprites/sierra.png", this);
    sierra1_2 -> setPos(692, 320);
    nivel1 -> addItem(sierra1_2);
    sierra1_3 = new Sierra(1, 50,50, ":/Mortys_Vindicator_Challenge/Sprites/sierra.png", this);
    sierra1_3 -> setPos(862, 320);
    nivel1 -> addItem(sierra1_3);
    sierra2_1 = new Sierra(2, 50,50, ":/Mortys_Vindicator_Challenge/Sprites/sierra.png", this);
